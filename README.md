...
Development: http://github.com/pudo/banal

A collection of small, dependency-free helper functions for everyday
Python work: coercing values to booleans and lists, flattening and
cleaning nested dictionaries, checking mapping and sequence types, and
caching keys for arbitrary objects.
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/banal-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/banal-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `banal` available on your platform:
...
```
pixi search banal --channel conda-forge
```
